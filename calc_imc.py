#Exercício – Ciclo 3 - Gabriel S. Fernandes
#Calculadora IMC Python com Interface usando GTK/Glade
...
class Handler(object):
    ...
    def on_bt_calc_clicked(self, button, msg_tx=str):
        ...
        self.text_buffer.set_text('Seu IMC é: {:.2f} sua situação é: {} '.format(imc, msg_tx))

    def on_main_destroy(self, window):
        Gtk.main_quit()

    def on_id_sair_clicked(self, window):
        Gtk.main_quit()
